...
function displayData(books) {
  ...
  books.forEach((book) => {
    ...
    classCard.className = "show-card col-lg-4 mb-5 position-relative";
    ...
    cardPrice.textContent = "السعر: " + book.price;
    ...
    cardContainer.className = "card-data border-0 bg-light shadow-sm pb-2 p-4";
